...
@Component({
  selector: 'app-private-layout2',
  templateUrl: './private-layout2.component.html',
  styleUrls: ['./private-layout2.component.css']
})
export class PrivateLayout2Component implements OnInit {
