...
@Component({
  selector: 'app-vertical2',
  templateUrl: './vertical2.component.html',
  styleUrls: ['./vertical2.component.css']
})
export class Vertical2Component implements OnInit, AfterViewInit {
